  ...
  return (
    <div>
      <div className="relative h-[100vh] bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('https://images.frandroid.com/wp-content/uploads/2022/10/netflix-octobre-contenus-2022.jpg')] bg-cover flex justify-center items-center p-[20px]">
        ...
        />
        <button className="fixed right-[20px] top-[10px] px-[20px] py-[10px] text-[white] bg-[#e40914] cursor-pointer font-semibold">
          Sign In
        </button>
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <form className="h-[40px] flex sm:w-[650px] w-[90%]">
                <input type="email" placeholder="Email Address" className="h-full flex-auto w-[75%] p-3 outline-0 border-none"/>
                <button className="text-[white] bg-[#e40914] cursor-pointer font-normal h-full flex-auto w-[25%] sm:text-[16px] text-[12px]">GET STARTED</button>
            </form>
        </div>
      </div>
    </div>
